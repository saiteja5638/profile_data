		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Object Status",
									"targetURL": "#objectstatus-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"objectstatus-display": {
								"semanticObject": "objectstatus",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=objectstatus",
									"url": sap.ui.require.toUrl("objectstatus")
								}
							}
						}
					}
